...
echo -e '⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠀⠀⠈⢿⡟⠙⠿⣿⣿⡟⠻⠃⠀⠙⠟⠀⠀⠀⠀⠀⠀⠀⠀'
echo -e '⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠁⠀⠀⠘⠻⠧⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀'
print_center -verm 'JA EXISTE UMA VERSÃO SIMILAR A ESTA, FORMATE A VPS PARA REINSTALAR!'
sleep 5
...
exit;
  ...
  echo -e "\033[1;37m┃              💿 S.O RECOMENDADO: UBUNTU 18.4\033[38;5;197m\033[38;5;197m\033[1;37m.                ┃\E[0m"
...
wget https://www.dropbox.com/s/vlwgp2v7sd6i16i/gestorssh.zip > /dev/null 2>&1
...
echo "     ║╣ ╠═╣║ ╦║  ║╣   ╠═╝╠═╣║║║║╣ ║    ║║║║╣ ╠╩╗  ╠╣ ╠╦╝║╣ ║╣ " | lolcat
echo "     ╚═╝╩ ╩╚═╝╩═╝╚═╝  ╩  ╩ ╩╝╚╝╚═╝╩═╝  ╚╩╝╚═╝╚═╝  ╚  ╩╚═╚═╝╚═╝⿻" | lolcat
echo -e "      SEU NOVO PAINEL WEB EAGLE ESTÁ INSTALADO COM SUCESSO! ❤️" | lolcat
echo ""
echo -e "    Desbloqueie o painel em nosso grupo telegram @MyEagleProject."
echo -e "        O desbloqueio deve ser feito antes de subir um backup."
echo ""
echo "                🚫 [ FAÇA O DESBLOQUEIO PARA FUNCIONAR ]" | lolcat   
echo ""
echo -e "ACESSE PELO NAVEGADOR " 
...
echo ""
echo -e "\033[1;31m \033[1;33mCOMANDO PRINCIPAL: \033[1;32mCONSOLE\033[0m"
echo ""
